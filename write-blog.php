...
<div class="navbar-fixed ">
  <nav>
    <div class="nav-wrapper black">
      <a href="#!" class="brand-logo" style="text-decoration:none;padding-left: 20px;">To all the Cricmaniacs</a>
    ...
    <form class="col s12" method="post" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="input-field col s9">
          ...
          <label for="category">Country To which team/member belongs</label>
        </div>
        </div>
        <div class="row">
