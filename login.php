...
">
 <div class="navbar-fixed ">
  <nav>
    <div style="padding-bottom: 80px;background-color: #000">
      <a href="index.php" class="brand-logo" style="text-decoration:none;color: #fff;padding-left: 20px;">To All The Cricmaniacs!!!</a>
...
<div class="container" style="width:50%;background-color:white;margin-top: 55px;">
  <h2>Login</h2>
